		...
		<div class="container">
			<div class="row">
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 logo-point">
						<a href="#"><img src="<%=request.getContextPath() %>/front/img/logo.png" ></a>
				</div>
								...
								<form class="panel-bodystyle" action="<%=request.getContextPath() %>/logindo" method="post">
									...
									<div class="wizard-field active" style="margin-top: 40px;">
										<div class="input-group">
											...
											<input name="user.ulogincode" type="text" class="form-control" placeholder="你的手机/邮箱" aria-describedby="basic-addon1" style="font-family: '微软雅黑';font-size: small;" >
										</div>
									</div>
				...
				<div class="qlogin" id="qlogin" style="display: none; ">
					...
					<div class="web_login">
						<div class="register_form">
							<form class="panel-bodystyle" action="<%=request.getContextPath() %>/registerdo" method="post">
								<div class=panel-error>
									<div></div>
								</div>
								<div class="wizard-field active" style="margin-top: 40px;">
  							...
  							<input name="user.ulogincode" type="text"  id="user" class="form-control" placeholder="手机/邮箱地址"   aria-describedby="sizing-addon1" onfocus="dianji();asd();" onblur="xianshi();qweasd();"  style="color: #000;font-family: '微软雅黑';font-size: small;">
									</div>
								...
								<div class="wizard-field active">
  								...
  								<span class="glyphicon glyphicon-lock"></span>
										...
										<input name="user.upassword" type="password" id="password" class="form-control" placeholder="设置密码" aria-describedby="sizing-addon1" onfocus="dianji1();asd1()" onblur="xianshi1();qweasd1()" style="color: #000;font-family: '微软雅黑';font-size: small;">
									</div>
    					...
    					<div class="input-group " style="margin-top: 30px;">
								...
								<div class="panel-footer text-xs-center" style="margin-top: 50px;">
									<div class="wizard-buttons">
										<button class="btn btn-lg btn-primary btn-block btn-blue" type="sumbit">
							注册
						</button>
